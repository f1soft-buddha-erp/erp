...
<html>
    <head>
        ...
        <script src="<c:url value='/static/js/service/DataShareService.js' />"></script>
        ...
        <script src="<c:url value='/static/js/controller/MachineryDetailModalCtrl.js' />"></script>
        <style type="text/css">
    ...
    <body ng-app="application" ng-controller="MachineryController">
        ...
        <div class="col-md-6">
            <table class="table table-striped" style="width: 100%">
                ...
                <tr ng-repeat="data in machineryListData.data">
                    ...
                    <td>
                        <a uib-tooltip="Details" ng-click="openDetailModal(data)" target="blank" style="cursor: pointer;margin: 0 2px;"><span class="glyphicon glyphicon-eye-open" style="color:black;"></span></a>
        ...
        <a href="#" ng-click="showMachineryAddStatus()">Add Machinery</a>
